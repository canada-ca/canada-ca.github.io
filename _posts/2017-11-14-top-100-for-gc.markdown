...
<img class="img-responsive" style="padding: 30px, 15px, 15px, 15px;" src="/images/top100piechart.png" alt="Pie chart showing one segment taking up one quarter, next 4 segments covering about half, and segments getting smaller till they blend into each other by the end. Data is from the top task list for Canada.ca">
<figcaption>
