...
---
Dans l’univers du numérique, les façons de recueillir des données sur le contenu que vous publiez sont nombreuses. L’analyse de ces données peut vous permettre d’obtenir de précieux renseignements sur le comportement des visiteurs et d’ajuster votre contenu. 
...
La premier constat de cette étude est que les utilisateurs de lecteurs d’écran étaient confrontés à un obstacle majeur dès leur arrivée sur le site ArriveCAN, en raison de l’accord sur la protection des renseignements personnels. Cet accord demandait au visiteur de cocher une case pour donner son accord avant de pouvoir poursuivre sa navigation. Les utilisateurs d’un lecteur d’écran se perdaient dans le texte de l’accord et ne parvenaient pas à cocher la case. Tous les participants ayant eu recours à un lecteur d’écran ont eu de la difficulté à franchir cette étape. Il a même fallu plus de trois minutes à l’un d’entre eux pour passer la page initiale de l’accord sur la protection des renseignements personnels. 

### Exploiter les données

Nous savions que nous devions mettre à disposition un accord sur la protection des renseignements personnels, sans savoir exactement comment le fournir.  Nous avons modifié la conception de la page en plaçant l’avis de confidentialité dans un format affichable/masquable. De cette façon, l’avis était accessible à ceux qui voulaient le lire et ne constituait pas d’obstacle ou d’étape supplémentaire pour les autres, notamment les utilisateurs de lecteur d’écran.
...
*	Tissez des liens avec les personnes de votre organisme qui interagissent directement avec vos publics clés. Ils détiennent de précieux renseignements (plus d’information à ce sujet dans un prochain billet sur le blogue).
